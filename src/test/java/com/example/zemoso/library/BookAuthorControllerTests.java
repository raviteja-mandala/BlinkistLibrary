...
class BookAuthorControllerTests {
    @Autowired
    private MockMvc mockMvc;

    @Test
    void addNewAuthorToBook() throws Exception {
    ...
    @Test
    void addDuplicateAuthorToBook() throws Exception {
    ...
    @Test
    void deleteAuthorToBook() throws Exception {
